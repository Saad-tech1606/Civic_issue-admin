...
import { LogOut, Bell, Globe, Lock, Shield, X, KeyRound } from "lucide-react";
...
const Toast = ({ show, message, onClose }) => {
  ...
  return (
    <div className="fixed right-6 bottom-6 z-[9999]">
      <div
        className="max-w-sm px-4 py-3 rounded-xl shadow-xl text-white bg-gradient-to-r from-indigo-600 to-purple-600
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="ml-2 rounded-full bg-white/20 hover:bg-white/30 px-2 py-1 text-sm"
...
const Modal = ({ open, title, children, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg rounded-2xl bg-gray-900 border border-white/10 text-white shadow-2xl overflow-hidden transform transition-transform duration-200"
...
const SettingsPage = ({ onLogout }) => {
  ...
  // Password inputs (local to modal)
  ...
  // Language change (show readable name)
  ...
  // Password save with simple mismatch check
  const handleSavePassword = () => {
    if (newPassword !== confirmPassword) {
      showToast(t("mismatch"));
      return;
    }
    // reset password inputs (not storing real passwords)
    setCurrentPassword("");
    setNewPassword("");
    setConfirmPassword("");
      ...
      <div className="max-w-5xl mx-auto">
        <header className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-400">{t("officialAccount")}</p>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 text-xs text-gray-400">
                    Pro tip: keep your profile information up-to-date.
                  </div>
                </div>
              </div>
          ...
          <section className="lg:col-span-2 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Protect your account with an extra step.</p>
                      </div>
                      <button
                        type="button"
              ...
              {/* Privacy Settings (full width on small screens) */}
              <div className="md:col-span-2 bg-gradient-to-b from-gray-900/70 to-gray-900/50 rounded-2xl p-6 shadow-lg border border-white/6">
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  ...
                  <span className="text-xs px-3 py-1 bg-gray-800/30 rounded-full text-gray-300">Online Status: {showOnline ? "Shown" : "Hidden"}</span>
