      ...
      >
        <div>
          ...
          <p className="text-center text-gray-500 text-sm mt-8">
            Already have an account? <a onClick={onToggle} className="text-indigo-400 hover:underline font-semibold cursor-pointer hover:text-indigo-300 transition-colors duration-200">Login</a> {/* Added hover:text and transition */}
          </p>
        </div>
      </div>
    </div>
